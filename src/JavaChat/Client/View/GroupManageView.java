...
public class GroupManageView {
    ...
    public static void start(Stage primaryStage) throws IOException {
        ...
        root = FXMLLoader.load(GroupManageView.class.getResource("fxml/GroupManage.fxml"));
        primaryStage.setTitle("管理群界面");
        scene = new Scene(root,1252,819);
        //        鼠标按下事件
